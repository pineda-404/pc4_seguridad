...
\subsection{V2: Análisis de Autovectores a Escalas Superiores ($z > 1$)}
Para comprobar el comportamiento del diseño a escalas no degeneradas ($z > 1$), extendimos de forma independiente el cálculo de la dimensión del kernel de la transformación lineal ($M \oplus I$) sobre $\mathbb{F}_2^{25z \times 25z}$ para valores de $z \in \{2, 4, 8\}$. Los resultados demuestran una ventaja estructural imprevista:
\begin{itemize}
